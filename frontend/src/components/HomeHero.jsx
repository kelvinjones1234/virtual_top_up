...
const HomeHero = () => {
  ...
  return (
    <div className="bg-bg_one md:h-screen bg-contain sm:bg-cover bg-center bg-no-repeat mx-auto px-4 ss:px-[5rem] w-full md:px-[4rem] pt-[22vh] lg:px-[8rem]">
      <div className="text-white text-center sm:text-left">
        ...
        <div className="bg-opacity-90 rounded-xl px-4 sm:w-[80%] sm:max-w-[700px] py-[3vh] bg-primary my-[3vh] shadow-lg shadow-indigo-900/10">
          ...
          <p className="font-body_two pb-[3vh]">
            At Atom, we understand the importance of staying connected. Whether
            you need to recharge your mobile phone, pay your utility bills, or
            purchase digital services, Atom is here to make it effortless. Our
            fast, secure, and user-friendly platform ensures you can top up
